...
function initializeWebsite() {
    ...
    // Only run if FAQ items exist on the current page.
    ...
    // --- Isotope Portfolio Filtering Logic ---
    const portfolioGrid = document.querySelector('.portfolio-grid');
    // Only run this if the portfolio grid exists on the current page.
    if (portfolioGrid) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        // If Swup.js library is not included, this will prevent the site from crashing.
